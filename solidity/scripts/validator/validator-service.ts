...
const providerChainA = new hre.ethers.providers.JsonRpcProvider('https://sepolia.infura.io/v3/199e48875a4f431e8ebaed6412865604'); //RPC one?
const providerChainB = new hre.ethers.providers.JsonRpcProvider('https://data-seed-prebsc-1-s1.binance.org:8545');
...
async function main() [
  ...
  providerChainA.on("Lock", handleLockEvent())
